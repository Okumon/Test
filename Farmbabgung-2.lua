...
local win = library:Window("    Reskin X ",[[     Hub | BF]],[[Ver:4.1]],"10729012702",Enum.KeyCode.RightControl)
local Tap = win:Tab("Main",[[7040391851]])
local Stats = win:Tab("Stats",[[7040410130]])
local Combat = win:Tab("PVP",[[9606626034]])
...
Tap:Toggle("Fastattack For Executor Quality","6022668898",false,function(value)
_G.Fast_Attack = true
...
Tap:Toggle("FastAttack For Mobile","6022668898",_G.Setting_table.Defaultat,function(v)
Defaultat = v
...
Tap:Toggle("BringMon","6022668898",_G.Setting_table.BringMonster,function(t)
      BringMonster = t
