...
spawn(function()
 ...
 --------------------------------------------------------------------
local Library = Update:Window("Sonic Hub","12462028268")
-------------------------------------------------------------------
spawn(function()
...
Main:Toggle("DisableDamage",false,function(value)
...
Setting:Toggle("Fast Attack",false,function(Fast)
    _G.FastAttack = Fast
end)
...
Setting:Toggle("Fast Attack [ไม่โดนเตะ ถ้าไม่แตะจอเปิดแล้วนิ่งไว้ ]",false,function(value)
...
Setting:Toggle("Black Screen",_G.BScreen,function(vu)
    _G.BScreen = vu
    if _G.BScreen then
